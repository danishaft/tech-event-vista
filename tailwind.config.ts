	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				"border-hover":
					"hsl(var(--border-hover) / var(--border-hover-opacity))",
			...
			boxShadow: {
				...
				"card-lg":
					"0px_0px_0px_1px_rgba(0,0,0,0.07),0px_15px_30px_-15px_rgba(0,0,0,0.20),0px_15px_15px_-8px_rgba(0,0,0,0.08),0px_12px_15.9px_-6px_rgba(0,0,0,0.03)",
				"card-xl":
					"0px_0px_0px_1px_rgba(0,0,0,0.11),0px_16px_24.4px_-12px_rgba(0,0,0,0.15),0px_25px_50px_-6px_rgba(0,0,0,0.13),0px_2px_2px_-2px_rgba(0,0,0,0.20)",
				input:
					"0px 0px 0px 1px rgba(0, 0, 0, 0.11), 0px 0px 1px 0px rgba(0, 0, 0, 0.07)",
			},
			borderRadius: {
				lg: "var(--radius)",
