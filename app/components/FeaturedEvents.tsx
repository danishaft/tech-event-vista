...
const featuredCities: FeaturedCity[] = [
	...
	},
	{
		...
		slug: "los-angeles",
		imageUrl:
			"https://images.unsplash.com/photo-1515895306158-367fac5f3a0e?w=200&h=200&fit=crop",
		eventCount: 89,
	},
	{
		name: "Chicago",
		slug: "chicago",
		imageUrl:
			"https://images.unsplash.com/photo-1513026705753-bc3fffca8bf4?w=200&h=200&fit=crop",
		eventCount: 72,
	},
	{
		name: "Denver",
		slug: "denver",
		imageUrl:
			"https://images.unsplash.com/photo-1470770903676-69b98201ea1c?w=200&h=200&fit=crop",
		eventCount: 43,
	},
];
...
export const FeaturedEvents = () => {
	...
	const handleCityClick = (citySlug: string) => {
		router.push(`/events?city=${citySlug}&platform=eventbrite`);
	};

	return (
		<section
			className="max-w-7xl mx-auto px-6 pt-spacing-section pb-spacing-content"
		...
		>
			...
			<ul className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4 md:gap-6 list-none m-0 p-0">
				{featuredCities.map((city) => (
					<li key={city.slug}>
						...
						>
							<article className="flex flex-col items-center p-4 md:p-6">
								<figure className="relative w-20 h-20 md:w-24 md:h-24 mb-3 rounded-full overflow-hidden border-2 border-border group-hover:border-primary/50 transition-colors">
									<Image
										src={city.imageUrl}
										alt={city.name}
										fill
