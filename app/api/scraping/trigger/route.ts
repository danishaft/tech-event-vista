...
export async function POST(request: NextRequest) {
  try {
    console.log('🔍 POST request received to /api/scraping/trigger')
...
export async function GET() {
  return NextResponse.json({
    success: true,
    message: 'Daily scraping trigger endpoint ready',
    endpoint: '/api/scraping/trigger',
    cron: {
      schedule: '0 6 * * *',
      description: 'Daily at 6:00 AM UTC (7:00 AM Nigeria time)',
